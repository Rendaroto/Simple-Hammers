...
public class Hammer {
    ...
    public static final DeferredItem<HammerItem> WOODEN_HAMMER = HAMMER_ITEMS.registerItem  (
            "wooden_hammer",
            properties -> new HammerItem(HammerTier.WOODEN_HAMMER,1,-2.8f, properties),
            new Item.Properties());
    public static final DeferredItem<HammerItem> STONE_HAMMER = HAMMER_ITEMS.registerItem  (
            "stone_hammer",
            properties -> new HammerItem(HammerTier.STONE_HAMMER,1,-2.8f,properties),
            new Item.Properties());
    public static final DeferredItem<HammerItem> GOLDEN_HAMMER = HAMMER_ITEMS.registerItem  (
            "golden_hammer",
            properties -> new HammerItem(HammerTier.GOLD_HAMMER,1,-2.8f,properties),
            new Item.Properties());
    public static final DeferredItem<HammerItem> IRON_HAMMER = HAMMER_ITEMS.registerItem  (
            "iron_hammer",
            properties -> new HammerItem(HammerTier.IRON_HAMMER,1,-2.8f,properties),
            new Item.Properties());
    public static final DeferredItem<HammerItem> DIAMOND_HAMMER = HAMMER_ITEMS.registerItem  (
            "diamond_hammer",
            properties -> new HammerItem(HammerTier.DIAMOND_HAMMER,1,-2.8f,properties),
            new Item.Properties());
